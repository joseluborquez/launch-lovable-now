      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <span className="text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">NoCode Jose</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Button variant="cta" size="default" onClick={() => scrollToSection("cta")}>
              Agenda tu reunión
            </Button>
          </div>
        ...
        {isMenuOpen && <div className="md:hidden py-4 space-y-4 animate-fade-in">
            ...
            <Button variant="cta" size="default" className="w-full" onClick={() => scrollToSection("cta")}>
              Agenda tu reunión
            </Button>
          </div>}
      </div>
